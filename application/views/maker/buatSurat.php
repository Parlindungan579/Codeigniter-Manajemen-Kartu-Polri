<div class="container-fluid" style="margin-bottom: 100px">
    ...
    <?= form_open('maker/buatSurat/buatSuratAksi'); ?>
    <div>
        <table>
            <tbody>
                ...
                foreach ($personel as $p) : ?>
                    <tr>
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="noSuratMaker[]" class=" form-control" value="<?php echo $p->tgl_input ?>/<?php echo $p->satker ?>/<?php echo $this->session->userdata('Tahap'); ?>/<?php echo $no++ ?>"><br>
                            </div>
                        </div>
