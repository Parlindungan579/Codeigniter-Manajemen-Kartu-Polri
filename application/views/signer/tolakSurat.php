<div class="container-fluid" style="margin-bottom: 100px">
    ...
    <?= form_open('signer/tolakSurat/tolakSuratAksi'); ?>
    <div>
        <table>
            <tbody>
                <?php $n = 0; ?>
                <?php if (count($personel)) :
                    foreach ($personel as $p) : ?>
                        <tr>
                            ...
                            <td align="center" style="display:none;"><input type="text" name="status_request[]" value="5"></td>
                        </tr>
                    <?php endforeach;
                    $n++; ?>
                <?php endif; ?>
        ...
        <div>
            <div class>
                <a class="mb-2 mt-2 btn btn-sm btn-success" href="<?php echo base_url('signer/checklistPermintaan') ?>"></i>Kembali</a>
