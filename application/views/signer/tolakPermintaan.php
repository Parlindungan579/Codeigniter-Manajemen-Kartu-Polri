<div class="container-fluid" style="margin-bottom: 100px">
    ...
    <form method="POST" action="<?php echo base_url('signer/tolakSurat') ?>">
        ...
        <div>
            <div class style="text-align: center;">
                ...
                <a class="mb-2 mt-2 btn btn-sm btn-success" href="<?php echo base_url('signer/checklistMabes') ?>"></i>BATAL</a>
            </div>
        </div>
